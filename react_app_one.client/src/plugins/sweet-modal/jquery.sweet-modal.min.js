...
! function e(t, n, r) {
                ...
                return null == placeholder && (placeholder = ""), null == value && (value = ""), null == successCallback && (successCallback = null), null == errorCallback && (errorCallback = null), content = $(templates.prepare(templates.prompt, {
                    ...
                    buttons: {
                        ...
                        ok: {
                            ...
                            action: function () {
                                if ($('.sweet-modal-prompt-input').attr('validate') == 'true') {
                                    if (validate('.sweet-modal-prompt')) {
    ...
    4: [function (require, module, exports) {
        module.exports = {
            ...
            prompt: '<div class="sweet-modal-prompt">\n	<div class="form-group"> <label class="bmd-label-floating sweet-modal-prompt-label"></label><input class="sweet-modal-prompt-input form-control text-center" type="{TYPE}" placeholder="{PLACEHOLDER}" value="{VALUE}" />\n </div></div>',
