...
$(document).ready(function () {
    ...
    showNotification: function (index, e, t, errorMessage) {
        if (index === 1) { $.notify({ icon: "add_alert", message: errorMessage }, { type: 'info', timer: 3e3, placement: { from: e, align: t } }) }
        if (index === 2) { $.notify({ icon: "add_alert", message: errorMessage }, { type: 'danger', timer: 3e3, placement: { from: e, align: t } }) }
        if (index === 3) { $.notify({ icon: "add_alert", message: errorMessage }, { type: 'success', timer: 3e3, placement: { from: e, align: t } }) }
        if (index === 4) { $.notify({ icon: "add_alert", message: errorMessage }, { type: 'warning', timer: 3e3, placement: { from: e, align: t } }) }
        if (index === 5) { $.notify({ icon: "add_alert", message: errorMessage }, { type: 'rose', timer: 3e3, placement: { from: e, align: t } }) }
        if (index === 6) { $.notify({ icon: "add_alert", message: errorMessage }, { type: 'primary', timer: 3e3, placement: { from: e, align: t } }) }
